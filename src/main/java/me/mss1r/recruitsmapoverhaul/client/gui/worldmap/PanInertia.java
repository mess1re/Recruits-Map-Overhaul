...
final class PanInertia {
    ...
    private long animationStartMillis = 0L;
    private double fromOffsetX = 0.0;
    private double fromOffsetZ = 0.0;
    private double targetOffsetX = 0.0;
    private double targetOffsetZ = 0.0;
    private double previousDragSampleX = 0.0;
    private double previousDragSampleY = 0.0;
    private long previousDragSampleNanos = 0L;
    private double lastDragSampleX = 0.0;
    private double lastDragSampleY = 0.0;
    private long lastDragSampleNanos = 0L;
    private double draggedDistance = 0.0;
    ...
    boolean finish(double mouseX, double mouseY, double scale, double minimumScale, double currentOffsetX, double currentOffsetZ) {
        ...
        double maxSpeed = MAX_SPEED_PIXELS / Math.max(scale, minimumScale);
        if (speed > maxSpeed) {
